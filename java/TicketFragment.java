...
public class TicketFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // Inflate the layout for this fragment and store it in a view variable
        View view = inflater.inflate(R.layout.fragment_ticket, container, false);

        // Handle click event of Home button
        Button btnTicket = view.findViewById(R.id.btn_buyticket);  // find button using its ID
        btnTicket.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // Navigate to DestinationFragment without data
                NavHostFragment.findNavController(TicketFragment.this)
                        .navigate(R.id.action_ticketFragment_to_orderTicketFragment);
            }
        });
